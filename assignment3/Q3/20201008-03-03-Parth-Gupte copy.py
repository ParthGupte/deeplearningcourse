...
class Network(object):
    ...
    def evaluate(self, test_data):
        ...
        return sum(int((x == y).all()) for (x, y) in test_results)
...
churn_predictor = Network([13,10,2])
w = churn_predictor.weights.copy()[0] 
churn_predictor.SGD(training_data[:7500],500,100,1,training_data[7500:])
...
# acc = churn_predictor.evaluate(training_data[7500:])
# print(acc)